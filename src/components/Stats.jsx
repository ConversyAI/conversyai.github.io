...
const Stats = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      const firebaseData = await getStats();

      // Optionally fetch from social media APIs
      const socialStats = await fetchAllSocialStats();

      // Merge data - API data takes precedence if available
      setStats({
        linkedinFollowers: socialStats.linkedinFollowers || firebaseData.linkedinFollowers || siteConfig.stats.linkedinFollowers,
        linkedinPageViews: socialStats.linkedinPageViews || firebaseData.linkedinPageViews || 0,
        instagramFollowers: socialStats.instagramFollowers || firebaseData.instagramFollowers || 850,
        uniqueVisitors: firebaseData.uniqueVisitors || siteConfig.stats.uniqueVisitors,
        waitlistCount: data.waitlistCount || siteConfig.stats.waitlistCount,
        linkedinViews: firebaseData.linkedinViews || siteConfig.stats.linkedinViews,
        instagramFollowers: firebaseData.instagramFollowers || siteConfig.stats.instagramFollowers,
      });
    };
    ...
    <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <motion.div
          ...
          className="flex flex-wrap justify-center gap-4 mt-12 flex-wrap"
        >
          <a
