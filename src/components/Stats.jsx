...
const Stats = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      setStats({
        linkedinFollowers: firebaseData.linkedinFollowers || siteConfig.stats.linkedinFollowers,
        uniqueVisitors: firebaseData.uniqueVisitors ?? siteConfig.stats.uniqueVisitors,
        waitlistCount: firebaseData.waitlistCount || siteConfig.stats.waitlistCount,
        linkedinPageViews: firebaseData.linkedinPageViews ?? siteConfig.stats.linkedinViews,
